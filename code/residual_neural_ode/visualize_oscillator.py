...
def print_summary(results):
    ...
    print(
        ...
        f"{metric(results, 'train_residual_norm_penalty')}"
    )
    print(
        "corr penalty           : "
        f"{metric(results, 'train_correlation_penalty')}"
    )
    print(
        "residual penalty weight: "
        f"{metric(results, 'residual_penalty_weight')}"
    )
    print(
        "corr penalty weight    : "
        f"{metric(results, 'correlation_penalty_weight')}"
    )
    print(
